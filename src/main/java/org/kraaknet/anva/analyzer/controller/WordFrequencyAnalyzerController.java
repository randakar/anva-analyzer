...
public class WordFrequencyAnalyzerController  {
    ...
    public FrequencyResponse calculateHighestFrequency(@Parameter(name = "request", description = "Text to analyze", required = true)
    ...
    public WordFrequency calculateFrequencyForWord(@Parameter(name = "request", description = "Text with word to analyze", required = true)
     ...
     *
     * @param request Text to analyze and word to look for (required)
     * @return A list of words with their frequencies in the text.
     */
    @Operation(
    ...
    public List<WordFrequency> calculateMostFrequentNWords(@Parameter(name = "request", description = "Text to analyze with results limit", required = true)
                                                           @NotNull @Valid @RequestBody final TopWordFrequencyRequest request) {
        return service.calculateMostFrequentNWords(request.text(), request.limit());
    }
}
